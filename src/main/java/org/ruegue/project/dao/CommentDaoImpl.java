...
public class CommentDaoImpl implements CommentDao {
    ...
    private static String namespace = "org.ruegue.project.dao.CommentMapper.";
    ...
    @Override
    public List<CommentDto> selectPage(CommentPageHandler commentPageHandler) throws Exception {
        return session.selectList(namespace + "selectPage", commentPageHandler);
    } // T selectOne(String statement, Object parameter)
